            ...
            <div class="container">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="grid">
                        ...
                        <div class="grid__item grid__item_item4 titel" ><label for="">selesai</label><span>*</span></div>
                        ...
                        <div class="grid__item grid__item_item14 inputan"><input type="datetime-local" name="report_date" id="report_date" class=""></div>
                        ...
                        <div class="grid__item grid__item_item20 inputan">
                            <br>
                            <div action="">
                                <input type="checkbox" id="surat" name="document[]" value="surat" required> 
                                <label for="surat">Surat Emergency</label> <input type="file" name="pdf" required><br>
                                <input type="checkbox" id="wp" name="document[]" value="wp" >
                        ...
                        <div class="grid__item grid__item_item42 inputan">
                            <table class="table table-bordered mt-2" id="dynamic_field1" style="">
                                <tr>
                                    ...
                                    <th rowspan="2"><button type="button" name="add3" id="add3" onclick="tambahBaris('dynamic1','lokasiManuverBebas[]','installManuverBebas[]','remote_bebas[]','real_bebas[]','ads_bebas[]')" class="btn green">Add More</button></th>
                                </tr>
                                <tr>
