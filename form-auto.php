      ...
      <div class="container">
        <form action="" method="post" enctype="multipart/form-data" id="form_id" >
                        ...
                        <div class="grid">
                            ...
                            <div class="grid__item grid__item_item12 inputan"><input type="text" value="<?= $data1["nama"]; ?>" name="lokasi" id="lokasi" class="form-control"></div>
                            <div class="grid__item grid__item_item13 inputan"><input type="text" value="<?= $data2["nama"]; ?>"name="instal" id="instal" class="form-control"></div>
